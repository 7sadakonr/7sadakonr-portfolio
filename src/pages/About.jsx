            ...
            <div className="glass-card">
              <div className="timeline">
                <div className="timeline-item">
                  ...
                  <div className="timeline-title">Bachelor's Degree in Computer Science</div>
                  <div className="timeline-subtitle">University</div>
                ...
                <div className="timeline-item">
                  ...
                  <div className="timeline-subtitle">Science-Mathematics Program</div>
                  <div className="timeline-description">
                    Developed strong foundation in mathematics, physics, and logical thinking.
                  </div>
                </div>
              </div>
            </div>
